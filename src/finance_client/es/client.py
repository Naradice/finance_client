...
class ESClient(ClientBase):
    def __init__(self, auto_index=False, frame=5, symbol="USDJPY", post_process=[], free_margin=1000000, seed=1017, user_name=None):
        """_summary_
        ...
        Args:
            ...
            free_margin (int, optional): _description_. Defaults to 1000000.
        ...
        """
        super().__init__(free_margin=free_margin, symbols=symbol, frame=frame, provider="vantage", post_processes=post_process, user_name=None)
        self.debug = False
        self.SYMBOL = symbol
        self.frame = frame
