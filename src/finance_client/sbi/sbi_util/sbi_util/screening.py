...
# Most of advanced search options have Range option

# dropdown items in advanced search
class ADVANCED_SEARCH_DROPDOWN(str, Enum):
    ADV_SEARCH_RATING_UPGRADE_TITLE = "レーティング上方修正"
    ADV_SEARCH_RATING_DOWNGRADE_TITLE = "レーティング下方修正"
    ADV_SEARCH_COMPANY_PERFORMANCE_FORECAST_UP_TITLE = "会社予想上方修正"
    ADV_SEARCH_COMPANY_PERFORMANCE_FORECAST_DOWN_TITLE = "会社予想下方修正"
    ADV_SEARCH_NEW_LOW_FOR_A_YEAR_TITLE = "年初来安値更新"
    ADV_SEARCH_NEW_HIGH_FOR_A_YEAR_TITLE = "年初来高値更新"
    ADV_SEARCH_OUTPERFORMANCE_NIKKEI225_TITLE ="日経平均の値上がり率上回り"
    ADV_SEARCH_UNDERPERFORMANCE_NIKKEI225_TITLE = "日経平均の値下がり率下回り"
    ADV_SEARCH_GOLDEN_CROSS_TITLE = "ゴールデンクロス" # ①, ②, ③
    ADV_SEARCH_DEAD_CROSS_TITLE = "デッドクロス" # ①, ②, ③
    ADV_SEARCH_RCI_TITLE = "RCI"
    ADV_SEARCH_STOCHASTIC_TITLE = "ストキャスティクス"
    ADV_SEARCH_SLOW_STOCHASTIC_TITLE = "スローストキャスティクス"

# dropdown options
class CONSENSUS_RATING_TERMS(Enum):
    W1_BEFORE = 0
    M1_BEFORE = 1
    M3_BEFORE = 2
    M6_BEFORE = 3
...
class COMPANY_PERFORMANCE_FORECAST_TERMS(Enum):
    W1_BEFORE = 0
    M1_BEFORE = 1
    M3_BEFORE = 2
    M6_BEFORE = 3
...
class COMPARE_WITH_NIKKEI225_TERMS(Enum):
    YESTERDAY = 0
    FIVE_BUSINESS_DAYS_BEFORE = 1
    TWENTY_BUSINESS_DAYS_BEFORE = 2
    THREE_MONTHS_BEFORE = 3
    SIX_MONTHS_BEFORE = 4
    ONE_YEAR_BEFORE = 5
    THREE_YEARS_BEFORE = 6
    FIVE_YEARS_BEFORE = 7

class GOLDEN_CROSS_TERMS(Enum):
    FIVE_DAY_TWENTY_FIVE_DAY = 0
    TWENTY_FIVE_DAY_SEVENTY_FIVE_DAY = 1
    SEVENTY_FIVE_DAY_TWO_HUNDRED_DAY = 2
    THIRTEEN_WEEK_TWENTY_SIX_WEEK = 3
    TWENTY_SIX_WEEK_FIFTY_TWO_WEEK = 4
    NINE_MONTH_TWENTY_FOUR_MONTH = 5
    TWENTY_FOUR_MONTH_SIXTY_MONTH = 6

class RCI_SIGNALS(Enum):
    BUY_SIGNAL = 0
    SELL_SIGNAL = 1

class STOCHASTIC_SIGNALS(Enum):
    BUY_SIGNAL = 0
    SELL_SIGNAL = 1

class SLOW_STOCHASTIC_SIGNALS(Enum):
    BUY_SIGNAL = 0
    SELL_SIGNAL = 1

class ADVANCED_SEARCH_RANGE_AND_DROPDOWN(str, Enum):
    ADV_SEARCH_RATING_CHANGE_TITLE = "コンセンサスレーティング変化幅(予)"
    ADV_SEARCH_CRASH_TITLE = "株価騰落【円】"
    ADV_SEARCH_CRASH_RATE_TITLE = "株価騰落【率】"
    ADV_SEARCH_MEAN_TRADING_VOLUME_TITLE = "平均売買代金(千円)" 
    ADV_SEARCH_PRICE_MA_DEVIATION_RATE_TITLE = "株価移動平均線乖離率"# There is 3 of them
    ADV_SEARCH_INCREASE_RATE_TITLE = "値上がり率(%)"
    ADV_SEARCH_DECREASE_RATE_TITLE = "値下がり率(%)"
    ADV_SEARCH_VOLUME_INCREASE_RATE_TITLE = "出来高増加率(倍)"
    ADV_SEARCH_SALES_INCREASE_RATE_TITLE = "売買代金増加率(倍)"
    ADV_SEARCH_RSI_TITLE = "RSI(%)"

class CRASH_RATE_TERMS(Enum):
    YESTERDAY = 0
    FIVE_WORKING_DAYS_BEFORE = 1
    SEVENTY_FIVE_WORKING_DAYS_BEFORE = 2
    THREE_MONTHS_BEFORE = 3
    SIX_MONTHS_BEFORE = 4
    ONE_YEAR_BEFORE = 5
    THREE_YEARS_BEFORE = 6
...
class MA_DEVIATION_RATE_TERMS(Enum):
    FIVE_WORKING_DAYS_BEFORE = 0
    TWENTY_FIVE_WORKING_DAYS_BEFORE = 1
    SEVENTY_FIVE_WORKING_DAYS_BEFORE = 2
    TWO_HUNDRED_WORKING_DAYS_BEFORE = 3
    THIRTEEN_WEEKS_BEFORE = 4
    TWENTY_SIX_WEEKS_BEFORE = 5
    FIFTY_TWO_WEEKS_BEFORE = 6
    NINE_MONTHS_BEFORE = 7
    TWENTY_FOUR_MONTHS_BEFORE = 8
    SIXTY_MONTHS_BEFORE = 9

class PRICE_MA_DEVIATION_RATE_TERMS(Enum):
    TODAY = 0
    FIVE_WORKING_DAYS_BEFORE = 1
    TWENTY_WORKING_DAYS_BEFORE = 2
    THREE_MONTHS_BEFORE = 3

class CHANGE_RATE_TERMS(Enum):
    YESTERDAY = 0
    FIVE_WORKING_DAYS_BEFORE = 1
    TWENTY_WORKING_DAYS_BEFORE = 2
    THREE_MONTHS_BEFORE = 3
...
class RSI_TERMS(Enum):
    DAY_14 = 0
    WEEK_9 = 1
    MONTH_9 = 2

# Advanced Search Otion: Two Dropdown Type
class ADVANCED_SEARCH_TWO_DROPDOWNS(Enum):
    ADV_SEARCH_BOLLINGER_BANDS_TITLE = "ボリンジャーバンド"
    ADV_SEARCH_DMI_TITLE = "DMI"
    ADV_SEARCH_MACD_TITLE = "MACD"

# TODO: Bolinger Bands options

class DMO_MACD_TERMS(Enum):
    DAY = 0
    WEEK = 1

class DMI_MACD_SIGNALS(Enum):
    BUY_SIGNAL = 0
    SELL_SIGNAL = 1

# Advanced Search Otion: Dropdown and Slider
class EARNINGS_SURPRISE_TITLE(Enum):
    TITLE = "サプライズ(決算)"

# TODO: implement slider selection

# Advanced Search Otion: Enabled Only
class ADVANCED_SEARCH_ENABLED_ONLY(str, Enum):
    ADV_SEARCH_ICHIMOKU_CLOUD_BREAKOUT_UP_TITLE = "一目均衡雲抜け上"
    ADV_SEARCH_ICHIMOKU_CLOUD_BREAKOUT_DOWN_TITLE = "一目均衡雲抜け下"
    ADV_SEARCH_NEW_PRICE_3LINE_TITLE = "新値3本足"
    ADV_SEARCH_SHORT_SELLING_POSSIBLE_STOCKS_TITLE = "売建可能銘柄"

# Advanced Search Otion: Table Type
class ADVANCED_SEARCH_TABLE_TYPE(str, Enum):
    ADV_SEARCH_SETTLEMENT_MONTH_TITLE = "決算月"
    ADV_SEARCH_BENEFIT_RIGHTS_CONFIRMATION_MONTH_TITLE = "優待権利確定月"
