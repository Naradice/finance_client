...
class TestLogRatingWithFile(unittest.TestCase):
    ...
    def test_add_a_rating(self):
        ...
        try:
            ...
            pass
        storage = db.PositionFileStorage(key, save_period=0, username=key, rating_log_path=self.rating_file_path)
    ...
    def test_add_ratings(self):
        ...
        try:
            ...
            pass
        storage = db.PositionFileStorage(key, username=key,save_period=0, rating_log_path=self.rating_file_path)
...
class TestLogRatingWithSQLite(unittest.TestCase):
    ...
    key = "test"
    storage = db.PositionSQLiteStorage(db_file_path, key, username=key)
