...
def __convert_country_code(common_code):
    conversion_dict = {
        cc.Australia: "australia", cc.Brazil: "brazil", cc.Canada: "canada",
        cc.China: "china", cc.EU: "european-union", cc.France: "france",
        cc.Germany: "germany", cc.HongKong: "hong-kong", cc.India: "india",
        cc.Italy: "italy", cc.Japan: "japan", cc.Mexico: "mexico",
        cc.NewZealand: "new-zealand", cc.Norway: "norway", cc.Singapore: "singapore",
        cc.SouthAfrica: "south-africa", cc.SouthKorea: "south-korea", cc.Spain: "spain",
        cc.Sweden: "sweden", cc.Switzerland:"switzerland", cc.UnitedKingdom: "united-kingdom",
